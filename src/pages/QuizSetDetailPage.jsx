...
import QuizResultDetailItem from "../components/Quiz/QuizResultDetailItem";
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                {quizResults.totalQuizCount}문제
              </div>
              <div>
                <span className="font-semibold">참여자 수:</span>{" "}
                {quizResults.participantCount}명
              </div>
            </div>
          </div>
                  ...
                  >
                    ...
                    <div className="grid grid-cols-3 gap-4 text-sm mb-3">
                      <div>
                        ...
                        {quiz.totalAttempts}회
                      </div>
                      <div>
                        <span className="font-semibold">정답:</span>{" "}
                        {quiz.correctAttempts}회
                      </div>
                      <div>
                        <span className="font-semibold">정답률:</span>{" "}
                        {quiz.accuracyRate.toFixed(1)}%
                      </div>
                    </div>
                    {quiz.difficulty && (
